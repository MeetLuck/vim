...
function! <sid>MapVimShortcut()
    ...
    nnoremap <buffer>  q    :call <sid>BufLeave__shortcut__()<cr>
    nnoremap <buffer>  <ESC>   :call <sid>BufLeave__shortcut__()<cr>
    nnoremap <buffer>  :   :call <sid>BufLeave__shortcut__()<cr>:
endfunction
...
function! <sid>BufLeave__shortcut__()
    autocmd! * <buffer>
...
function! <sid>Openwindow()
    ...
    autocmd! * <buffer>
    autocmd BufLeave <buffer>   :echomsg '>>bufleave!' | call <sid>BufLeave__shortcut__()
endfunction
